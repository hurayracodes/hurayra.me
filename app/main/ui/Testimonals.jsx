  ...
  return (
    <div className="flex flex-col items-center gap-10 py-16">
      ...
      <div className="relative px-8">
        ...
        <p
          className={cn(
            "text-2xl md:text-3xl font-light text-gray-100 text-center max-w-lg leading-relaxed transition-all duration-400 ease-out",
        ...
        <span className="absolute -right-2 -bottom-8 text-7xl font-serif text-slate-50 select-none pointer-events-none">
          "
        </span>
      </div>
